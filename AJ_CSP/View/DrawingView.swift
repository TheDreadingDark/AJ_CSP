...
//  AJ_CSP
//
//  Created by Woolsey, Adam on 12/5/17.
...
class DrawingView: UIView
{
    ...
    // An empty implementation adversely adversely affects performance during animation.
    ...
    public func drawHappyTree() -> Void
    {
        ...
        bobRoss.close()
        UIColor(patternImage: UIImage(named: "cute rammus")!).setFill()
